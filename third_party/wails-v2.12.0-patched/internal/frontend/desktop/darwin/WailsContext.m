...
// Grant WKWebView media-capture (getUserMedia) permission requests. Without this
// WKUIDelegate method, macOS 12+ auto-denies camera/microphone access in the
// embedded webview. The OS-level TCC prompt still gates actual access via the
// app's NSMicrophoneUsageDescription / NSCameraUsageDescription.
